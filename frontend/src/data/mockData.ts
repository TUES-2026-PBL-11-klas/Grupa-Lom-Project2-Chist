...
export const REPORTS = [
  ...
  { id:7, title:"Строителни отпадъци", location:"ж.к. Младост 1, до бл. 37", district:"Младост", lat:42.656, lng:23.378, status:"open", severity:"critical", img:"🏗️", points:180, reporter:"EcoHero99", reporterAvatar:"🦅", time:"преди 6ч", description:"Строителни отпадъци — бетон, тухли и арматура — изхвърлени на зелената площ до блока.", volunteers:0, confirmedBy:["CleanCity"], aiVerified:true, gps:{lat:42.6562,lng:23.3781} },
  { id:8, title:"Пластмаса в реката", location:"р. Перловска, до бул. Сливница", district:"Илинден", lat:42.709, lng:23.305, status:"in-progress", severity:"high", img:"🏞️", points:150, reporter:"CleanCity", reporterAvatar:"🏙️", time:"преди 8ч", description:"Пластмасови бутилки и найлони замърсяват коритото на реката. Нужна е координирана акция.", volunteers:2, confirmedBy:["EcoHero99"], aiVerified:true, claimedBy:"NadezhDA", gps:{lat:42.7091,lng:23.3053} },
  { id:9, title:"Графити и боклук", location:"Подлез НДК", district:"Триадица", lat:42.685, lng:23.318, status:"done", severity:"medium", img:"🎨", points:60, reporter:"BorisovaKing", reporterAvatar:"👑", time:"преди 1д", description:"Натрупани отпадъци и графити в подлеза. Почистването включва и пребоядисване.", volunteers:1, confirmedBy:["GreenSofia","EcoHero99"], aiVerified:true, cleanedBy:"SofiaClean", gps:{lat:42.6852,lng:23.3182} },
  { id:10, title:"Опасни отпадъци — батерии", location:"ж.к. Дружба 2, до училище", district:"Искър", lat:42.667, lng:23.398, status:"open", severity:"critical", img:"🔋", points:250, reporter:"UniVolunteer", reporterAvatar:"🎓", time:"преди 12ч", description:"Изхвърлени батерии и електронни компоненти в непосредствена близост до училищен двор. Спешно!", volunteers:0, confirmedBy:[], aiVerified:false, gps:{lat:42.6672,lng:23.3983} },
];

export const LEADERBOARD = [
  { rank:1, id:"usr_001", name:"EcoHero99",    points:4820, streak:14, level:"ЛЕГЕНДА",  levelIcon:"🏆", avatar:"🦅", cleanings:54, verified:true  },
  { rank:2, id:"usr_002", name:"GreenSofia",   points:3670, streak:7,  level:"МАСТЪР",   levelIcon:"💎", avatar:"🌿", cleanings:31, verified:false },
  { rank:3, id:"usr_003", name:"CleanCity",    points:2910, streak:21, level:"МАСТЪР",   levelIcon:"💎", avatar:"🏙️", cleanings:28, verified:true  },
  { rank:4, id:"usr_004", name:"UniVolunteer", points:1540, streak:3,  level:"ПРО",      levelIcon:"🥈", avatar:"🎓", cleanings:15, verified:false },
  { rank:5, id:"usr_005", name:"NadezhDA",     points:980,  streak:5,  level:"АКТИВЕН",  levelIcon:"🥉", avatar:"⭐", cleanings:9,  verified:false },
  { rank:6, id:"usr_006", name:"SofiaClean",   points:720,  streak:2,  level:"АКТИВЕН",  levelIcon:"🥉", avatar:"🌟", cleanings:7,  verified:false },
  { rank:7, id:"usr_007", name:"BorisovaKing", points:480,  streak:0,  level:"НОВИЧ",    levelIcon:"🌱", avatar:"👑", cleanings:4,  verified:false },
];
...
export const BADGES = [
  { id:"first_report",  icon:"🌱", name:"Първи сигнал",     desc:"Докладва първото замърсяване",    earned:true,  pts:15   },
  { id:"first_clean",   icon:"🧹", name:"Първо почистване", desc:"Почисти първото замърсяване",     earned:true,  pts:40   },
  { id:"streak_7",      icon:"🔥", name:"7-дневен стрийк",  desc:"Активен 7 последователни дни",    earned:true,  pts:100  },
  { id:"clean_10",      icon:"💪", name:"10 почиствания",   desc:"Завърши 10 успешни почиствания",  earned:false, pts:200  },
  { id:"verified",      icon:"✅", name:"Verified User",    desc:"Доказана активност и надеждност",  earned:false, pts:500  },
  { id:"eco_legend",    icon:"🌍", name:"Еко легенда",      desc:"Достигни 5000 точки",             earned:false, pts:1000 },
  { id:"district_hero", icon:"🏘️", name:"Герой на района",  desc:"Почисти 5 места в един район",    earned:false, pts:300  },
  { id:"team_player",   icon:"🤝", name:"Екипен играч",     desc:"Потвърди 20 задачи на другите",   earned:false, pts:250  },
];
